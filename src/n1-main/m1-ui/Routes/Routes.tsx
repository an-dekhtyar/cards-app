...
import {SearchCards} from '../../../n2-features/h2-cards/a1-search/search_cards/SearchCards';
import {Learn} from '../../../n2-features/h2-cards/a3-process-of-learning/Learn';
...
export const Routes = () => (
    <div>
        <Switch>
            ...
            <Route path={PATH.CARDS} render={() => <SearchCards/>}/>
