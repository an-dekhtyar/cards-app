...
import {
    ...
    DeleteCardsCardThunk, GetCardsCardThunk,
...
export const ProfileCards = () => {
    ...
    let dataForTable = useSelector<AppStoreType, InitialCardProfileReducerType>(state => state.cardProfile)
    ...
    useEffect(() => {
        ...
        if (UserId){
            dispatch(GetCardsCardThunk(UserId,setPreloader))
        }
    }, [])
    ...
    return (
        <div className={st.profilePage}>
            ...
            {showDeleteModal&&<DeleteModal setShowDeleteModal={setShowDeleteModal} idForModal={idForModal} setPreloader={setPreloader}/>}
            {showUpdateProfileModal&&<UpdateProfileModal setShowUpdateProfileModal={setShowUpdateProfileModal} idForModal={idForModal} setPreloader={setPreloader}/>}
            {AddNewCardModal&&<AddNewCardProfileModal setAddNewCardModal={setAddNewCardModal} setPreloader={setPreloader}/>}
            <div className={st.profile}>{
                dataForTable !== undefined ?
                    dataForTable.cards.map((m) => {
                        return (
                            <div>
                                <ul>
                                    <li>
